define(["exports", "jx/core/JXObject"], function (exports, _JXObject2) {
    ...
    var YScaleDisappear = function (_JXObject) {
        _inherits(YScaleDisappear, _JXObject);

        function YScaleDisappear(_ref) {
            _objectDestructuringEmpty(_ref);

            _classCallCheck(this, YScaleDisappear);

            return _possibleConstructorReturn(this, (YScaleDisappear.__proto__ || Object.getPrototypeOf(YScaleDisappear)).call(this));
        }

        _createClass(YScaleDisappear, [{
            key: "run",
        ...
        return YScaleDisappear;
    }(_JXObject3.default);

    exports.default = YScaleDisappear;
});
//# sourceMappingURL=YScaleDisappear.js.map