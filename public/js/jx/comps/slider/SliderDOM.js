define(["exports", "jx/comps/visualcomponent/VisualComponentDOM"], function (exports, _VisualComponentDOM2) {
    ...
    var SliderDOM = function (_VisualComponentDOM) {
        _inherits(SliderDOM, _VisualComponentDOM);

        function SliderDOM(dataObject) {
            _classCallCheck(this, SliderDOM);

            var _this = _possibleConstructorReturn(this, (SliderDOM.__proto__ || Object.getPrototypeOf(SliderDOM)).call(this, Object.assign({ id: "", min: 0, max: null, step: null }, dataObject)));
    ...
    exports.default = SliderDOM;
});
//# sourceMappingURL=SliderDOM.js.map