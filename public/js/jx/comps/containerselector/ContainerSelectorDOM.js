define(["exports", "jx/comps/container/containerDOM"], function (exports, _containerDOM2) {
    "use strict";
    ...
    var _containerDOM3 = _interopRequireDefault(_containerDOM2);
    ...
    var ContainerSelectorDOM = function (_containerDOM) {
        _inherits(ContainerSelectorDOM, _containerDOM);

        function ContainerSelectorDOM(dataObject) {
            _classCallCheck(this, ContainerSelectorDOM);

            var _this = _possibleConstructorReturn(this, (ContainerSelectorDOM.__proto__ || Object.getPrototypeOf(ContainerSelectorDOM)).call(this, Object.assign({}, dataObject)));

            console.log("ContainerDOM", _this.dataObject);
            return _this;
        }

        _createClass(ContainerSelectorDOM, [{
            key: "_create",
            value: function _create() {
                _get(ContainerSelectorDOM.prototype.__proto__ || Object.getPrototypeOf(ContainerSelectorDOM.prototype), "_create", this).call(this);
                this.children = [];
        ...
        return ContainerSelectorDOM;
    }(_containerDOM3.default);

    exports.default = ContainerSelectorDOM;
});
//# sourceMappingURL=ContainerSelectorDOM.js.map