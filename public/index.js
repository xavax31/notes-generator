...
var StageGameModule_1 = require("jx/core/presets/StageGameModule");
var Screen00_1 = require("src/screens/Screen00");
var MainCtrl = /** @class */ (function (_super) {
    ...
    */
    MainCtrl.prototype.init = function (onInitialised) {
        ...
        this.screens.add({ id: "intro", type: "ScreenVideo", rid: "INTRO", bgMusicVolPC: 0, stage: this.stage, onfinished: function (evt) {
                _this.jx.dj.music.play({ id: "MUSIC" });
                _this.screens.go("screen00");
            }
        });
        this.screens.add({ id: "screen00", type: Screen00_1.default, stage: this.stage, onfinished: function (evt) {
            }
        });
